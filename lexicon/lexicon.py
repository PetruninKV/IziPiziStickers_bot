LEXICON_MESSAGE: dict[str, str] = {
    ...
    '/demo': 'Ты присылаешь мне свое фото, а я - убираю фон, делаю нужный размер, так чтобы бот принял файл. '
             'Вот пример:',
    '/demo continue': 'Готовый файл можно переслать боту @Stickers и он его примет. ИзиПизи ;) \n'
