LEXICON_MESSAGE: dict[str, str] = {
    '/start': 'Приветики, мои хорошие! \nОт моего сердечка твоему душевно в душу! 🥰',
    '/start continue': '🔝🔝🔝\nОцени мой набор стикеров - просто нажми на него. \nХочешь собственные?\n'
                       'Начни с /instruction или воспользуйся навигацией из <pre>Меню</pre>',
    ...
    '/formatting': 'Отлично! Можно отправить изображения c сжатием, а можно отправить без сжатия - документом. '
                   'Я работаю с обоими форматами.\nОтправляй фото по одной. Тайм-аут между обработкой - 10 сек.',
    '/formatting_continue': 'Чтобы выйти из режима редактирования фото - команда /stop_formatting',
    '/stop_formatting': 'Режим редактирования фото выключен. Надеюсь результатом довольны. Жду Вас снова!\n'
                        'Присылайте получившиеся стикерпаки. Мне будет интересно посмотреть! Для этого отправьте '
                        'одним сообщением команду /feedback и ссылку на ваш стикерпак.\nВ таком формате:\n'
                        '<pre>/feedback https://t.me/addstickers/NyKoneshno</pre>',
    '/stop_formatting_error': 'Вы находитесь вне режима редактирования фото',
    'formatting_work_on': 'Пришли мне фото или изображение в виде документа - jpg, png, webp. \nЧтобы выйти из '
                          'режима редактирования фото - команда /stop_formatting ',
    '/feedback': 'Спасибо! ❤️\nЯ передам создателю ссылку:\n{link}',
    '/feedback_er': 'Неправильный формат.\nПришли одним сообщением в таком формате:\n'
                    '<pre>/feedback https://t.me/addstickers/NyKoneshno</pre>',
...
LEXICON_ADMIN: dict[str, str] = {
    '/admin': 'Доступные команды:\n    - /stat - показать статистику;\n    - /ban - добавить в список '
              'заблокированных;\n    - /unban - удалить из списка заблокированных;\n    - /blacklist - '
              'посмотреть список заблокированных;\n    - /text - отправить сообoщение пользователям;\n    '
              '- /exit - для выхода из кабинета администратора.',
    '/stat': 'Показываю статистику:',
    '/ban': 'Пришли кого нужно заблокировать.\nДля отмены ввода - /cancel',
    'ban': 'Добавлнены в список заблокированых',
    '/unban': 'Пришли кого нужно разблокировать.\nДля отмены ввода - /cancel',
    'unban': 'Удалены из списока заблокированых',
    '/blacklist': 'В списке заблокированных:\n<code>{users}</code>',
    '/text': 'Отправь мне текст и я перешлю его всем пользователям.\nДля выхода из режима отправки сообщений - '
             '/cancel ',
    'send_text': 'Хотите отправить что то другое?\nДля выхода в меню администратора - /cancel',
    'send_error': 'Сообщение не удалось отправить:\n<code>{users}</code>',
}
...
LEXICON_MIDDLEWARES: dict[str, str] = {
    ...
    'flood_feedback': 'Подозрительная активность.',
}
