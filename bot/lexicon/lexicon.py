...
LEXICON_ADMIN: dict[str, str] = {
    '/admin': 'Доступные команды:\n    - /stat - показать статистику;\n    - /block_user - добавить в список '
              'заблокированных;\n    - /unblock_user - удалить из списка заблокированных;\n    - /black_list - '
    ...
    '/block_user': 'Пришли кого нужно заблокировать',
    '/unblock_user': 'Пришли кого нужно разблокировать',
