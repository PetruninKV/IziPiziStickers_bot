LEXICON_MESSAGE: dict[str, str] = {
    ...
    '/formatting': 'Отлично! Отправь мне свои фото. Можно отправить изображения c сжатием, а можно '
                   'отправить без сжатия - документом. Я работаю с обоими форматами. Тайм-аут между запросами - 10сек.',
